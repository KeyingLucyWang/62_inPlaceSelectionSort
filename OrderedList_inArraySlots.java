...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        list_iAS = unordered;
        for (int currentIndex = 0; currentIndex < unordered.size(); currentIndex++){
          for (int index = currentIndex; index < unordered.size(); index++ ){
            int currentElement = unordered.get( currentIndex);
            int element = unordered.get(index);
            if( currentElement > element){
              unordered.set( currentIndex, element);
              unordered.set( index, currentElement);
          }
        }
      }
        // System.out.println( 
